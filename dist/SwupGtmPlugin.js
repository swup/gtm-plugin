...
var GtmPlugin = function (_Plugin) {
    ...
    function GtmPlugin() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GtmPlugin.__proto__ || Object.getPrototypeOf(GtmPlugin)).call.apply(_ref, [this].concat(args))), _this), _this.name = "SwupGtmPlugin", _temp), _possibleConstructorReturn(_this, _ret);
    }
